...
| 5. Player can create an account | FAILED |  |  |  |
| 6. Player can save a game state | PASS |  |  |  |
| 7. Player can load a game state | PASS |  |  |  |
| 8. Player can place a Meeple into the tile | PASS |  |  |  |
| 9. Player can login | FAILED |  |  |  |
| 10. Player can finish the game and see the results | PASS |  |  |  |
